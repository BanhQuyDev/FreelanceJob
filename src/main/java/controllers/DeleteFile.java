...
public class DeleteFile extends HttpServlet {
    ...
    private static final String SUCCESS = "GetAllFileOfJob";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String urlFile = request.getParameter("urlS3");
            FileDAO fileDao = new FileDAO();
            if (fileDao.deleteFile(idFile)) {
                String keyName = S3Util.getKeyName(urlFile);
