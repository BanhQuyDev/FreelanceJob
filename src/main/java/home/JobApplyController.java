 ...
 * @author Admin
 */
@WebServlet(name = "JobApplyController", urlPatterns = {"/JobApplyController"})
public class JobApplyController extends HttpServlet {

    private static final String ERROR = "job_management.jsp";
    private static final String SUCCESS = "job_management.jsp";
