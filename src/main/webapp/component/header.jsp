                                                ...
                                                <div class="arrow_box_right">
                                                    <c:choose>
                                                        ...
                                                        <c:when test="${sessionScope.MODE == 'EMPLOYER'}">
                                                            ...
                                                            <a class="dropdown-item" href="GetNewBalance?id_freelancer=${sessionScope.LOGIN_USER.id}">
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" style="width: 24px; height: 21px; padding-right: 8px;">
