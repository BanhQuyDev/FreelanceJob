        ...
        <jsp:include page="component/header.jsp"></jsp:include>
            <div class="container">
                <div style="margin-top: 25px; ">
                    <h1 style="text-align: center">Điều khoản sử dụng dành cho Khách hàng</h1>
                    <div class="wrapper-content">
                        <h2>1. Tài khoản khách hàng</h2>
                        <p>Website FPTFreelanceJob.vn (“FPTFreelanceJob”, “Chúng tôi”) là nền tảng kết nối Khách hàng và Freelancer tại Việt Nam. FPTFreelanceJob.vn có xuất thân từ cộng đồng Freelancer Việt Nam hơn 500.000 thành viên làm việc đa lĩnh vực.</p>
                        <p>Để duy trì môi trường làm việc chất lượng cao cho Khách hàng, mọi thông tin được cung cấp trong tài khoản người dùng FPTFreelanceJob phải đảm bảo tính trung thực và có nguồn kiểm chứng:</p>
                        <ul>
                        ...
                        <p>Với tính năng Đẩy top tự động: Khi Khách hàng sử dụng tính năng “Đẩy top tự động”, hệ thống trên FPTFreelanceJob.vn sẽ tự động đẩy top dự án tối đa 01 lần/giờ liên tục trong khoảng thời gian do Khách hàng lựa chọn. Khách hàng có thể lựa chọn sử dụng tính năng “Đẩy top tự động” trong 24h (1 ngày), 72h (3 ngày) hoặc 168h (7 ngày).&nbsp;</p>
                        ...
                        <p>Khách hàng không thể dừng hoặc hủy đẩy top dự án khi đã bắt đầu sử dụng tính năng đẩy top dự án. Credit sẽ không được hoàn lại khi Khách hàng đã chọn Đẩy top tức thì hoặc Đẩy top tự động. Trong mọi trường hợp, quyết định của FPTFreelanceJob.vn là quyết định cuối cùng.</p>
                        ...
                        <p>&nbsp;</p>
                        <h2>3. Cuộc thi thiết kế</h2>
                        <p><strong>3.1. Cuộc thi thiết kế</strong></p>
                        <p>“Cuộc thi thiết kế” (“Cuộc thi”) là cuộc thi có mức giải thưởng cố định, được khởi tạo bởi Khách hàng. Cuộc thi thiết kế cho phép Khách hàng có thể nhận các “Bài dự thi” (“Mẫu thiết kế”, “Bản thiết kế”) từ các Freelancer thiết kế (“Designer”) trên FPTFreelanceJob.vn. Cuộc thi thiết kế giúp Khách hàng có thể nhận được nhiều mẫu thiết kế khác nhau, cho yêu cầu của mình, sau đó trao giải cho bài dự thi tốt nhất và nhận bản thiết kế hoàn chỉnh và quyền sở hữu bản thiết kế này.</p>
                        <p>3.1.1. Khởi tạo cuộc thi thiết kế</p>
                        <p>Để kích hoạt một Cuộc thi thiết kế trên FPTFreelanceJob.vn, Khách hàng khởi tạo Cuộc thi thiết kế theo 2 bước: (1) Đăng yêu cầu thiết kế ; (2) Điền các thông tin giải thưởng cuộc thi. Sau khi Khách hàng xác nhận giải thưởng, cuộc thi mới được hiển thị và có thể nhận được các bài dự thi.</p>
                        <p>3.1.2. Cuộc thi bí mật.</p>
                        <p>Chỉ Khách hàng tạo cuộc thi mới có quyền được xem tất cả các bài dự thi. Các thí sinh không xem được bài dự thi của nhau. Hạn chế việc sao chép ý tưởng giữa các Freelancer. Đồng thời đảm bảo ngoài Khách hàng, không một ai khác xem được các mẫu thiết kế tham gia dự thi. Freelancer chiến thắng tại vòng 2 sẽ được công khai trên FPTFreelanceJob.vn. Freelance chiến thắng chung cuộc sẽ được công khai trên FPTFreelanceJob.vn&nbsp;<br>
                            <br>
                            <strong>3.2. Quy trình làm việc đối với Cuộc thi Thiết kế</strong></p>
                        <p>Cuộc thi thiết kế diễn ra trong 3 vòng, (1) Vòng 1, Freelancer nhận mẫu thiết kế. (Toàn bộ Freelancer trên FPTFreelanceJob.vn sẽ nhìn thấy cuộc thi - trừ cuộc thi bí mật). Freelancer được đăng tải tối đa 05 mẫu thiết kế dự thi cho mỗi cuộc thi. Sau tối đa 07 ngày, Khách hàng lựa chọn tối thiểu 01 và tối đa 04 mẫu thiết kế lọt vào vòng trong. (2) Vòng 2, Khách hàng liên hệ làm việc với tối thiểu 01 và tối đa 04 Freelancer sở hữu mẫu thiết kế được chọn từ Vòng 1. Freelancer sẽ hoàn thiện mẫu thiết kế dự thi của mình theo ý Khách hàng. Khách hàng làm việc với Freelancer trong 7 ngày. Sau khi Freelancer hoàn thiện bài dự thi, Khách hàng sẽ chọn người để trao giải thưởng tại vòng 3. (3) Vòng 3, Khách hàng chọn ra mẫu thiết kế cuối cùng để trao giải thưởng.&nbsp;</p>
                        <p>Kết thúc Vòng 1, Khách hàng chọn tối thiểu 01 và tối đa 04 mẫu thiết kế vào Vòng 2. Trong trường hợp khi đã quá hạn 07 ngày diễn ra Vòng 1 và cuộc thi không nhận được bất kỳ bài dự thi nào, Khách hàng có quyền hủy giải thưởng. Khách hàng sẽ không thể hủy cuộc thi tại Vòng 1 khi đã có từ 01 bài dự thi được đăng tải. Khách hàng cần phải chọn ra tối thiểu 01 bài dự thi, tối đa 04 bài dự thi để tiếp tục vào Vòng 2.</p>
                        <p>Tại Vòng 2, Khách hàng có thời gian là 07 ngày để làm việc tiếp tục với các Freelancer có bài dự thi được lựa chọn trong Vòng này. Cuối Vòng 2, Khách hàng cần chọn ra 01 và chỉ 01 bài dự thi có chất lượng tốt nhất để đưa vào Vòng 3. Trong trường hợp Khách hàng không chọn được mẫu thiết kế vào Vòng 3, Khách hàng có thể hủy cuộc thi. FPTFreelanceJob.vn sẽ thu phí 25% trên tổng giá trị giải thưởng của cuộc thi Khách hàng muốn hủy. Trong mức phí 25%: 20% được chia đều cho các bài dự thi được được vào Vòng 2 , 5% phí dịch vụ của FPTFreelanceJob.vn.</p>
                        <p>Tại Vòng 3, Khách hàng không thể hủy cuộc thi. Khách hàng làm việc với Freelancer trong tối đa 07 ngày để hoàn thiện sản phẩm. Sau tối đa 07 ngày, Freelancer gửi lại bản gốc để Khách hàng nghiệm thu. Sau nghiệm thu, Khách hàng xác nhận kết thúc công việc và trao giải cho Freelancer. Nếu quá thời hạn 72h, Khách hàng chưa trao giải cho Freelancer, FPTFreelanceJob.vn có thể chủ động trao giải thay cho Khách hàng sau khi được Khách hàng ủy thác.<br>
                            <br>
                            <strong>3.3. Quy định về trao đổi và sử dụng bài dự thi</strong></p>
                        <p>Khách hàng không sử dụng bất kỳ mẫu thiết kế nào ngoại trừ mẫu thiết kế đã được trao giải. Các Freelancer sẽ không cung cấp cho Khách hàng bản thiết kế gốc của mình (ngoại trừ Freelancer chiến thắng). Khách hàng không được yêu cầu hoặc cho phép Freelancer nộp mẫu thiết kế dự thi ngoài hệ thống FPTFreelanceJob.vn.&nbsp;<br>
                            <br>
                            <strong>3.4. Chi phí</strong></p>
                        <p>3.4.1. Chi phí gia hạn cuộc thi</p>
                        <p>Khách hàng gia hạn lần đầu tiên: được miễn phí gia hạn. Khách hàng gia hạn từ lần thứ hai: cần 10 credit/lần gia hạn Thời gian gia hạn: tùy theo lĩnh vực cuộc thi mà bạn đăng.</p>
                        <p>3.4.2. Chi phí cuộc thi bí mật</p>
                        <p>Chi phí cuộc thi bí mật: 15% ngân sách giải thưởng. Chi phí cuộc thi bí mật&nbsp;không được tính vào ngân sách giải thưởng và sẽ không được hoàn lại trong mọi trường hợp. Ngoại trừ trong trường hợp khách hàng yêu cầu hủy cuộc thi vì không nhận được bất kỳ bài dự thi nào từ Freelancer sau khi hết hạn Vòng 1, phí cuộc thi bí mật mới được hoàn lại.&nbsp;</p>
                        <h2>&nbsp;</h2>
                        ...
                        <p>Chúng tôi không giám sát, kiểm duyệt, hoặc điều tra thông tin phản hồi. Tuy nhiên, trong một số trường hợp, chúng tôi có thể xóa xếp hạng và phản hồi nếu phát hiện vi phạm Điều khoản sử dụng của FPTFreelanceJob hoặc các hướng dẫn chi tiết dưới đây.</p>
