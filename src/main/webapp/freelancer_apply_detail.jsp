                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center text-center">
                                    <img
                                        src="${requestScope.FREELANCER_DETAIL.picture}"
                                        alt="${requestScope.FREELANCER_DETAIL.name}"
                                        class="rounded-circle"
                                        width="150"
                                        />
                                    <div class="mt-3">
                                        <h4>${requestScope.FREELANCER_DETAIL.name}</h4>
                                        <p class="text-muted font-size-lg"><strong>Bio: </strong> ${requestScope.FREELANCER_DETAIL.bio}</p>
                                        <div class="text-left">
                                            <span class="font-weight-bold">Skills: </span>
                                            <c:forEach items="${requestScope.LIST_SKILL}" var="S">
                        ...
                        <div class="card mt-3">
                            <ul class="list-group list-group-flush">
                                <li
                                    ...
                                    <span class="text-secondary">${requestScope.FREELANCER_DETAIL.email}</span>
                                </li>
                            </ul>
                        </div>
                        <div class="card mt-3">
                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary">${requestScope.FREELANCER_DETAIL.name}</div>
                                </div>
                                <hr />
                                <div class="row">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">${requestScope.FREELANCER_DETAIL.email}</div>
                                </div>
                                <hr />
                                <div class="row">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">${requestScope.FREELANCER_DETAIL.phone}</div>
                                </div>
                                <hr />
                                <div class="row">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">${requestScope.FREELANCER_DETAIL.dob}</div>
                                </div>
                                <hr />
                                <div class="row">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        ${requestScope.FREELANCER_DETAIL.address}
                                    </div>
                                </div>
                                <hr />
                            </div>
