                                                    ...
                                                    <form class="col-4" style="position: relative; margin-bottom: 35px" action="ApproveFreelancerController" method="POST">
                                                        <div class="p-4 h-100 w-100" style="border-radius: 14px; border: 2px solid #007bff">
                                                            ...
                                                            <div class="row text-center mt-4">
                                                                <div class="col-6">
                                                                    <button class="bg-info text-light border-0 p-3" style="cursor: pointer; border-radius: 15px; font-size: 17px; font-weight: 600;">
                                                                        <a href="FreeLancerDetailController?id_freelancer=${LF.id_freelancer}"><i class="fas fa-address-card mr-2"></i> Profile</a>
                                                                    </button>
                                                                </div>
                                                                <div class="col-6" >
