                ...
                <div class="container">
                    <div style="margin-top: 25px">
                        ...
                        <div class="wrapper-content">
                            ...
                            <p>Thỏa thuận sau đây là một thỏa thuận ràng buộc pháp lý giữa Bạn (có thể là "Khách hàng" hoặc "Freelancer" và nhóm điều hành mạng cộng đồng vLance® ("Chúng tôi”). Thỏa thuận bao gồm các điều khoản dịch vụ mà bạn phải tuân thủ để có được quyền tiếp cận và sử dụng dịch vụ của chúng tôi. Tại từng thời điểm, chúng tôi có thể cập nhật Điều khoản dịch vụ theo quyết định của mình mà không cần thông báo trực tiếp cho bạn. Bạn chịu trách nhiệm tìm hiểu phiên bản mới nhất bằng cách truy cập website www.vLance.vn.</p>
                            ...
                            <p>vLance® là cộng đồng online kết nối những freelancer tìm việc để kiếm thêm thu nhập và những khách hàng, những công ty cần tìm kiếm nguồn nhân lực chất lượng với chi phí hợp lý và hiệu quả cao. vLance® cung cấp những công cụ, tiện ích trực tuyến giúp cả freelancer và khách hàng quản lý công việc, giao dịch và thanh toán. vLance® cũng tạo ra một môi trường công bằng nơi các bên được bảo vệ quyền lợi đích đáng và an tâm khi giao dịch. Những tiện ích của vLance® sẽ được gọi chung là "Dịch vụ". Bạn hiểu và đồng ý rằng Dịch Vụ này sẽ bao gồm một số thông tin liên lạc của Ban quản trị vLance® qua các phương tiện như email, SMS, Website... Các thông tin liên lạc này được coi là một phần không tách rời của Dịch vụ và Bạn sẽ không có khả năng từ chối nhận các thông tin này trừ khi Bạn chấm dứt việc sử dụng tài khoản của mình trên vLance.vn.</p>
                            <p><strong>vLance® KHÔNG PHẢI LÀ ĐƠN VỊ CUNG CẤP DỊCH VỤ VIỆC LÀM, CŨNG KHÔNG PHẢI ĐƠN VỊ MÔI GIỚI VIỆC LÀM. CHÚNG TÔI CHỈ CUNG CẤP NHỮNG TIỆN ÍCH ĐỂ CÁC BÊN GIAO DỊCH, HỖ TRỢ CHO CÁC BÊN TRONG QUÁ TRÌNH THỰC HIỆN CÁC GIAO DỊCH. </strong></p>
                            ...
                            <p>Chúng tôi không bán hoặc cho thuê thông tin của bạn cho bên thứ ba ngoài hệ thống vLance&nbsp;mà không có sự cho phép của bạn và chúng tôi chỉ sử dụng thông tin của bạn như được mô tả trong Điều khoản riêng tư. Chúng tôi xem bảo vệ sự riêng tư của người sử dụng như một nguyên tắc cộng đồng quan trọng hàng đầu. Bạn có thể xem xét lại chính sách bảo mật hiện tại của chúng tôi tại Điều khoản riêng tư.</p>
                      
                            <p><strong>9. SỞ HỮU TRÍ TUỆ</strong></p>
               
                            <p>Tất cả quyền sở hữu trí tuệ hiện có trong các Dịch vụ của vLance® đều thuộc về vLance® hoặc cấp phép hợp pháp cho vLance® sử dụng. Theo đó, tất cả các quyền lợi hợp pháp đều được đảm bảo. Trừ phi nhận được sự đồng ý của vLance®, bạn không được phép tải lên, gửi, xuất bản, sửa đổi, tái sản xuất, truyền hoặc phân phát dưới bất cứ hình thức nào các Dịch vụ vLance® cung cấp. Chúng tôi có toàn quyền, bao gồm nhưng không chỉ giới hạn các quyền tác giả, thương hiệu và các quyền sở hữu khác mà chúng tôi có trong các Dịch vụ của vLance®.Tất cả các yếu tố cấu thành nên Dịch vụ mà chúng tôi cung cấp đều thuộc phạm vi sở hữu của chúng tôi cho dù đã đăng ký hoặc chưa đăng ký. Việc sử dụng quyền sở hữu của chúng tôi cần phải được chúng tôi cho phép trước bằng văn bản. Ngoài việc cấp phép bằng văn bản, chúng tôi không cấp phép dưới bất kỳ hình thức nào khác cho dù đó là hình thức công bố hay hàm ý, hoặc thông qua việc để bạn sử dụng dịch vụ. Và do vậy, bạn không có quyền sử dụng Dịch vụ của chúng tôi vào mục đích thương mại mà không có sự cho phép bằng văn bản của chúng tôi trước đó. Bạn đồng ý để chúng tôi tự do sử dụng, tiết lộ, áp dụng và sửa đổi bất kỳ ý tưởng, khái niệm, cách thức, đề xuất, gợi ý, bình luận hoặc hình thức thông báo nào khác mà bạn cung cấp cho chúng tôi (“Phản hồi”) có liên quan tới vLance® và/hoặc dịch vụ của vLance® một cách hoàn toàn miễn phí. Bạn từ bỏ và đồng ý từ bỏ bất kỳ quyền và yêu cầu với bất kỳ khoản tiền thưởng, nhuận bút, lệ phí và/ hoặc các hình thức thanh toán khác liên quan đến việc chúng tôi sử dụng, tiết lộ, áp dụng, và/hoặc chỉnh sửa bất kỳ hoặc tất cả Phản hồi của bạn.</p>
